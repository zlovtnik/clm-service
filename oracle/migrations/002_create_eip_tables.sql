...
-- Add foreign key constraint to ensure referential integrity with etl_sessions
ALTER TABLE data_quality_issues ADD CONSTRAINT fk_dq_session
    FOREIGN KEY (session_id) REFERENCES etl_sessions(session_id) ON DELETE SET NULL;
